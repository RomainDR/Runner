...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    /**
     * Get the blocks without type.
     *
     * @param blacklist The list of materials to exclude
     * @return The blocks in the Cuboid without the blacklisted types
     */
    public List<Block> getBlocksWithout(Set<Material> blacklist) {
    ...
    public boolean contains(Block b) {
        return this.containsInWorld(b.getLocation());
    }
